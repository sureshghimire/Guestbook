...
public class GuestBook extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		entries.add(new GuestBookEntry("Jack","Testing"));
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//get the List saved on application scope
		...
		out.println("<html><title>GuestBook Entry </title><body>");
		...
		for(GuestBookEntry entry : entries) {
			...
			out.println("| <a href ='DeleteEntry?id="+entry.getId()+"'>Delete</td>");
	...
	// there is nothing to do with doPost method here now
